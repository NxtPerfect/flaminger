        ...
        {technologies.map((technology, index) => {
          return (
            <div key={index} className="flex flex-row items-center">
              ...
              <ActionButton variant="formSubmit" className="mt-0 h-fit py-1 px-6 bg-red-600 hover:bg-red-600/80 duration-75" onClick={(e) => removeTechnology(e, index)}><TrashBinSvg className="size-4 h-5" /></ActionButton>
            </div>
          )
        })}
